...
public final class StreamServiceClient implements StreamService {
  ...
  public void reply(example.Request message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<example.Response> observer) {
    ...
    io.netty.buffer.ByteBuf metadata = com.jauntsdn.rsocket.generated_48882.ProtobufCodec.encodeHeaders(headersMetadata);
    ...
    com.jauntsdn.rsocket.generated_48882.ProtobufCodec.encode("StreamServiceClient", content, message);
    ...
    streams.requestResponse(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_48882.ProtobufCodec.decode("StreamServiceClient", example.Response.parser()), instrumentationListener));
  }
  ...
  public void serverStream(example.Request message, com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<example.Response> observer) {
    ...
    streams.requestStream(msg, com.jauntsdn.rsocket.RpcMessageCodec.Stream.Client.decode(observer, com.jauntsdn.rsocket.generated_48882.ProtobufCodec.decode("StreamServiceClient", example.Response.parser()), instrumentationListener));
  }
  ...
  public io.grpc.stub.StreamObserver<example.Request> bidiStream(com.jauntsdn.rsocket.Headers headersMetadata, io.grpc.stub.StreamObserver<example.Response> observer) {
    ...
    io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> bidiStreamRequest = streams.requestChannel(
      com.jauntsdn.rsocket.RpcMessageCodec.Channel.Client.decode(observer, bidiStreamEncoder, com.jauntsdn.rsocket.generated_48882.ProtobufCodec.decode("StreamServiceClient", example.Response.parser()), instrumentationListener));
