  ...
  public io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> requestChannel(com.jauntsdn.rsocket.Message message, io.grpc.stub.StreamObserver<com.jauntsdn.rsocket.Message> observer) {
    try {
      ...
      if (com.jauntsdn.rsocket.Rpc.RpcMetadata.flagForeignCall(flags)) {
        ...
        observer.onError(new com.jauntsdn.rsocket.exceptions.RpcException("StreamServiceServer: unknown foreign method: " + method));
        return com.jauntsdn.rsocket.MessageStreamsHandler.noopServerObserver();
      }
      observer.onError(new com.jauntsdn.rsocket.exceptions.RpcException("StreamServiceServer: requestChannel(Message, Observer<Message>) not implemented"));
      return com.jauntsdn.rsocket.MessageStreamsHandler.noopServerObserver();
    } catch (Throwable t) {
      observer.onError(t);
      return com.jauntsdn.rsocket.MessageStreamsHandler.noopServerObserver();
    ...
    return new java.util.function.Function<com.jauntsdn.rsocket.Message, T>() {
      ...
      public T apply(com.jauntsdn.rsocket.Message message) {
        try {
          ...
          com.jauntsdn.rsocket.exceptions.Exceptions.throwIfJvmFatal(t);
          throw new com.jauntsdn.rsocket.exceptions.SerializationException("StreamServiceServer: message deserialization error", t);
        } finally {
          message.release();
        }
      }
